...
public final class TypeHandlerRegistry {
    ...
    //java ->jdbcType String->char varchar
    private final Map<Type, Map<JdbcType, TypeHandler<?>>> typeHandlerMap = new ConcurrentHashMap<>();
    //
    private final TypeHandler<Object> unknownTypeHandler = new UnknownTypeHandler(this);
    //所有的TypeHandler
    private final Map<Class<?>, TypeHandler<?>> allTypeHandlersMap = new HashMap<>();
    //null TypeHandler 集合的标识
    private static final Map<JdbcType, TypeHandler<?>> NULL_TYPE_HANDLER_MAP = Collections.emptyMap();
    // 默认枚举类型
    private Class<? extends TypeHandler> defaultEnumTypeHandler = EnumTypeHandler.class;

    /**
     * TypeHandlerRegistry，注册 java<->jdbc TypeHandler
     */
     ...
     * <p>
     * 等价于下面的代码
     * Map<JdbcType, TypeHandler<?>> jdbcTypeTypeHandlerMap = typeHandlerMap.computeIfAbsent(javaType, type -> new HashMap<>());
